        ...
        <>
            ...
            <section className={"bg-white px-5 pt-10 md:pt-15 md:px-10 lg:pt-20 lg:px-48 xl:px-60 flex flex-col w-full xl:flex-row justify-center"}>
                <div className="w-full mb-10">
                    <h1 className={"text-3xl text-neutral-800 font-bold mb-5 text-center"}>Seeds for Trees : A Loblolly Pine Legacy</h1>

                    <div className={"flex flex-col xl:flex-row gap-6 w-full"}>
                        <div className={"basis-1/3"}>
                            <h2 className={"text-2xl text-neutral-800 font-bold mb-5"}>Ecological Diversity</h2>
                            <p className={"text-neutral-500 text-justify mb-5"}>
                            ...
                            <h2 className={"text-2xl text-neutral-800 font-bold mb-5"}>Why choose Loblolly Pine ?</h2>
                        ...
                        <div className={"basis-1/3"}>
                            <h2 className={"text-2xl text-neutral-800 font-bold mb-5"}>Carbon Sequestration</h2>
                            <p className={"text-neutral-500 text-justify"}>
            ...
            <section className={"bg-white px-5 pt-0 pb-10 md:b-15 md:px-10 lg:pb-20 lg:px-48 xl:px-60 flex flex-col w-full xl:flex-row justify-center"}>
                <div className="w-full mb-10">
                    <h2 className={"text-3xl text-neutral-800 font-bold mb-5 text-center"}>Our Deciduous Trees</h2>
